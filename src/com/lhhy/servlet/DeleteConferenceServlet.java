...
/**
 * Servlet implementation class DeleteConferenceServlet
 */
@WebServlet("/jsp/DeleteConferenceServlet")
public class DeleteConferenceServlet extends HttpServlet {
     ...
     */
    public DeleteConferenceServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String rs = biz.deleteConference(id);
